        ...
        <div class="form-section">
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" id="name" name="name" class="form-input" value="{{ $school->name }}" required>
                    <div class="error-message" id="nameError">Please enter a valid name</div>
                </div>
                <div class="form-group">
                    <label class="form-label" for="email">Email Address</label>
                    <input type="email" id="email" name="email" class="form-input" value="{{ $school->email }}">
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="tel" id="phone" name="phone" class="form-input" value="{{ $school->phone }}">
                </div>
            </div>

            <div class="form-row">
                <div class="form-group">
                    <label class="form-label" for="joinedDate">Expiration Date</label>
                    <input type="date" id="joinedDate" name="expiration_date" class="form-input" value="{{ (isset($school->details)) ? $school->details->expiration_date : ''}}">
                </div>
            </div>
        </div>
    </div>
        ...
        $(document).ready(function() {
            ...
            staffForm.on('submit', function(e) {
                ...
                if (validateForm()) {
                    ...
                    var staffId = '{{$school->id}}';
                    submitBtn.text('Updating...').prop('disabled', true); 
                    // for (var pair of formData.entries()) {
                    //     console.log(pair[0]+ ': ' + pair[1]);
                    // }
                    $.ajax({
                        url: "{{ route('admin.schools.update', '') }}/" + staffId,
                        type: 'POST',
                        headers: {  
