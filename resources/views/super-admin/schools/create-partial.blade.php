...
<form id="staffForm">
    <div class="form-content">
        ...
        <div class="form-section">
            ...
            <div class="form-row">
                <div class="form-group">
                    <label class="form-label" for="joinedDate">Expiry Date</label>
                    <input type="date" id="joinedDate" name="expiration_date" class="form-input">
                </div>
            </div>
        </div>
    </div>
                ...
                if (validateForm()) {
                    ...
                    $.ajax({
                        ...
                        error: function(xhr) {
                            ...
                            toastr.error('There was an error while creating the School.');
                        }
                    });
