        ...
        <div class="form-section">
            <div class="form-row">     
                <div class="form-group">
                    <label class="form-label"  for="faculty-select-create">Select Faculty:</label>
                    <select id="faculty-select-create" class="faculty-select form-select">
                ...
                <div class="form-group">
                    ...
                    <label class="form-label"  for="batch-select-create">Select Batch:</label>
                    <select id="batch-select-create" class="form-select" disabled>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <label class="form-label"  for="class-select-create">Select Class:</label>
                    <select id="class-select-create" class="form-select">
                ...
                <div class="form-group">
                    ...
                    <label class="form-label"  for="section-select-create">Select Section:</label>
                    <select id="section-select-create" class="form-select" disabled>
            ...
            <div class="form-row">
                <div class="form-group">
                    <label class="form-label" for="name-create">
                        Full Name <span class="required">*</span>
                    </label>
                    <input type="text" id="name-create" name="name" class="form-input" required>
                    <div class="error-message" id="nameError">Please enter a valid name</div>
                </div>
                <div class="form-group">
                    <label class="form-label" for="email-create">Email Address</label>
                    <input type="email" id="email-create" name="email" class="form-input">
                </div>
            </div>

            <div class="form-row">
                <div class="form-group">
                    <label class="form-label" for="phone-create">Phone Number</label>
                    <input type="tel" id="phone-create" name="phone" class="form-input">
                </div>
                <div class="form-group">
                    <label class="form-label" for="gender-create">Gender</label>
                    <select id="gender-create" name="gender" class="form-select">
            ...
            <div class="form-row">
                <div class="form-group">
                    <label class="form-label" for="handicapped-create">Handicapped</label>
                    <select id="handicapped-create" name="handicapped" class="form-select">
        ...
        $(document).ready(function() {
            ...
            staffForm.on('submit', function(e) {
                ...
                if (validateForm()) {
                    ...
                    formData.append('name', $('#name-create').val());
                    formData.append('email', $('#email-create').val());
                    formData.append('phone', $('#phone-create').val());
                    formData.append('gender', $('#gender-create').val());
                    formData.append('address', $('#address-create').val());
                    formData.append('faculty_id', $('#faculty-select-create').val());
            ...
            $('#faculty-select-create').on('change', function() {
                var facultyId = $(this).val();

                // Disable batch, class, and section initially
                $('#batch-select-create').prop('disabled', true);
                $('#class-select-create').prop('disabled', true);
                $('#section-select-create').prop('disabled', true);
                // Reset the class and section selects to empty values
                $('#class-select-create').empty().append('<option value="">Select Class</option>');
                $('#section-select-create').empty().append('<option value="">Select Section</option>');

                if(facultyId) {
                    // Enable batch dropdown
                    $('#batch-select-create').prop('disabled', false);
                    ...
                    $.ajax({
                        ...
                        type: 'GET',
                        success: function(data) {
                            $('#batch-select-create').empty().append('<option value="">Select Batch</option>');
                            $.each(data, function(key, value) {
                                $('#batch-select-create').append('<option value="' + value.id + '">' + value.title + '</option>');
                            });
                        }
                    });
                } else {
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            $('#class-select-create').empty().append('<option value="">Select Class</option>');
                            $.each(data, function(key, value) {
                                $('#class-select-create').append('<option value="' + value.id + '">' + value.title + '</option>');
                            });

                            // Enable class dropdown
                            $('#class-select-create').prop('disabled', false);
                        }
                    });
                }
            });
            ...
            $('#batch-select-create').on('change', function() {
            ...
            $('#class-select-create').on('change', function() {
                ...
                if(classId) {
                    ...
                    $('#section-select-create').prop('disabled', false);
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            $('#section-select-create').empty().append('<option value="">Select Section</option>');
                            $.each(data, function(key, value) {
                                $('#section-select-create').append('<option value="' + value.id + '">' + value.title + '</option>');
                            });
                        }
                    });
                } else {
