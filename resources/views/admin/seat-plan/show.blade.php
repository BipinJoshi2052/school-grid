    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-7 align-self-center">
                <h3 class="page-title text-truncate text-dark font-weight-medium mb-1">{{$data['seat_plan']['title']}}!</h3>
    ...
    <script>
        $(document).ready(function() {
            ...
            function generateTotalLayout(room,roomIndex) {
                ...
                const students = getStudentsForRoom(currentBuildingId, currentRoomId); // This should return an array of students
                console.log([
...
console.log(bench.seats)
            ...
            for (let seatIndex = 0; seatIndex < bench.seats; seatIndex++) {
                if (studentIndex < students.length) {
                    const student = students[studentIndex]; // Fetch the student for the seat
                    html += `
                        <div class="seat-student">
                            <div class="student-info">
                                <div class="student-name">${student.name}</div>
                    ...
                    html += '<div class="seat"></div>';  // Empty seat if no student is assigned
                }
            }
