...
<body style="font-family: 'Arial', sans-serif;background-color: #f8fafc;line-height: 1.6;color: #333333;">
    <div class="email-container"
        ...
        <div class="header"
            ...
            <p style="font-size: 16px;opacity: 0.9;font-weight: 300;color:white;">Secure your account with OTP
                verification</p>
        </div>

        <!-- Content -->
        <div style="padding: 40px 30px;text-align: center;" class="content">
            <div style="font-size: 20px;color: #333;margin-bottom: 20px;font-weight: 600;" class="greeting">Welcome to
                Seat Plan Pro!</div>
            ...
            <div style="font-size: 16px;color: #666;margin-bottom: 30px;line-height: 1.7;" class="message">
                ...
                To complete your account setup and ensure security, please verify your email address using the OTP code
                below.
            </div>

            <!-- OTP Container -->
            <div style="background: linear-gradient(135deg, #667eea10 0%, #764ba220 100%);border: 2px dashed #667eea;border-radius: 12px;padding: 30px;margin: 30px 0;text-align: center;"
                class="otp-container">
                <div style="font-size: 14px;color: #666;margin-bottom: 10px;text-transform: uppercase;letter-spacing: 1px;font-weight: 600;"
                    class="otp-label">Your Verification Code</div>
                <div style="font-size: 36px;font-weight: bold;color: #667eea;font-family: 'Courier New', monospace;letter-spacing: 8px;margin: 10px 0;"
                    class="otp-code">
                    {{ $otp }}
                </div>
                <div style="font-size: 14px;color: #e74c3c;margin-top: 15px;font-weight: 600;" class="otp-validity">⏰
                    Valid for 10 minutes</div>
            </div>

            <!-- Instructions -->
            <div style="background-color: #f8fafc;border-left: 4px solid #667eea;padding: 20px;margin: 30px 0;text-align: left;border-radius: 0 8px 8px 0;"
                class="instructions">
                ...
                <ol style="margin-left: 20px;color: #666;">
                    ...
                    <li style="margin-bottom: 8px;font-size: 14px;">Click "Verify Account" to complete your registration
                    </li>
            ...
            <!-- Security Note -->
            <div style="background: linear-gradient(135deg, #ffeaa7 0%, #fab1a0 100%);border-radius: 8px;padding: 20px;margin: 25px 0;border-left: 4px solid #e17055;"
                class="security-note">
                <h4
                    style="color: #d63031;margin-bottom: 8px;font-size: 16px;display: flex;align-items: center;gap: 8px;">
                ...
                <p style="color: #2d3436;font-size: 14px;line-height: 1.5;">
                    Never share this OTP code with anyone. Seat Plan Pro staff will never ask for your verification
                    code.
                    If you didn't request this verification, please ignore this email or contact our support team.
                </p>
            </div>

            <div style="height: 1px;background: linear-gradient(90deg, transparent 0%, #667eea 50%, transparent 100%);margin: 25px 0;"
                class="divider"></div>
        ...
        <!-- Footer -->
        <div style="background-color: #f8fafc;padding: 30px;text-align: center;border-top: 1px solid #e1e8ed;"
            class="footer">
            ...
            {{-- <div style="margin: 20px 0;" class="social-links">
                ...
                <a style="display: inline-block;width: 36px;height: 36px;background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);color: white;text-decoration: none;border-radius: 50%;margin: 0 8px;line-height: 36px;font-size: 16px;transition: transform 0.3s ease;"
                    onmouseover="this.style.transform='translateY(-2px)'"
                    onmouseout="this.style.transform='translateY(0)'" href="#" title="Twitter">🐦</a>
                <a style="display: inline-block;width: 36px;height: 36px;background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);color: white;text-decoration: none;border-radius: 50%;margin: 0 8px;line-height: 36px;font-size: 16px;transition: transform 0.3s ease;"
                    onmouseover="this.style.transform='translateY(-2px)'"
                    onmouseout="this.style.transform='translateY(0)'" href="#" title="LinkedIn">💼</a>
                <a style="display: inline-block;width: 36px;height: 36px;background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);color: white;text-decoration: none;border-radius: 50%;margin: 0 8px;line-height: 36px;font-size: 16px;transition: transform 0.3s ease;"
                    onmouseover="this.style.transform='translateY(-2px)'"
